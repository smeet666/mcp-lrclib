...
<https://github.com/smeet666/mcp-lrclib/security/advisories/new>. It reaches me
...
This server is a read-only client for LRCLIB. It holds no credentials, needs no
API key, opens no port, and writes nothing back to LRCLIB. That rules out most
of what a vulnerability report usually concerns.

What remains is worth reporting:

- **Anything that lets a caller reach a host other than LRCLIB.** The URLs are
...
Rate limiting by LRCLIB, or LRCLIB being down, is the upstream's business and
